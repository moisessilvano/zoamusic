...
<head>
    ...
    <title>Termos de Uso — ZOA MUSIC</title>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#E8D9A8]">
        <div class="mb-10 text-center">
            <a href="/" class="inline-flex items-center gap-2 mb-6">
                ...
                <span class="text-xl font-bold tracking-widest">ZOA MUSIC<span class="text-[#C9A84C]">.NET</span></span>
            </a>
        ...
        <div class="prose prose-stone max-w-none space-y-6 text-sm md:text-base leading-relaxed text-[#44403C]">
            <section>
                ...
                <p>Ao acessar e utilizar o ZOA MUSIC, você concorda em cumprir e estar vinculado a estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deverá utilizar nossos serviços.</p>
            </section>

            <section>
                <h2 class="text-lg font-bold text-[#1C1917] mb-2">2. Descrição do Serviço</h2>
                <p>O ZOA MUSIC é uma plataforma que utiliza Inteligência Artificial para gerar letras e melodias musicais baseadas em informações fornecidas pelo usuário. O serviço é prestado mediante pagamento único por composição.</p>
            </section>
            ...
            <section>
                ...
                <p>A música gerada é para uso pessoal do usuário. O usuário possui o direito de compartilhar, baixar e reproduzir a obra para fins não comerciais. O ZOA MUSIC retém o direito de manter a obra em seus servidores e utilizá-la para fins de demonstração da plataforma, preservando a privacidade do usuário quando solicitado.</p>
            </section>
            ...
            <section>
                ...
                <p>O ZOA MUSIC não garante que a interpretação da IA corresponderá exatamente às expectativas subjetivas do usuário. A IA é uma ferramenta criativa e os resultados podem variar.</p>
            </section>
        </div>
